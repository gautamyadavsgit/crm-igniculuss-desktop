  ...
  <nav class="bg-white border-gray-200 dark:bg-gray-900">
    <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
      <button
        ...
        class="text-black bg-white  focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium noto-sans-500 rounded-full text-xl px-5 py-2.5 text-center inline-flex items-center "
        type="button"
      >
        Dropdown button
        <svg

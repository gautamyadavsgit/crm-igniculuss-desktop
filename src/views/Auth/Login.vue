<template>
  <auth-vue>
    <div class="pt-[18vh] w-[38.0555555556vw] max-w-[376px] m-auto">
      ...
      <div class="mt-[5vh]">
        <Form @submit="handleSubmit">
          ...
          <form-input v-model="formData.password" inputName="Password" inputType="password" />
          <form-bottom button-text="Submit"></form-bottom>
        </Form>
      </div>
    </div>
  </auth-vue>
